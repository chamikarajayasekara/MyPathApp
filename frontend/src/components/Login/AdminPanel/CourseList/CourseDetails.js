                ...
                <div className="col-md-12 mb-3">
                    ...
                    <div className="row row-1">
                        ...
                        <div className="col-md-8">
                            <Breadcrumbs aria-label="breadcrumb" className="ml-1 mt-2 text-white"><span><Link to="/CourseList" style={{textDecoration:"none",color:"white"}}> Course List</Link> > {this.state.result.name}</span></Breadcrumbs>
                            <h2 className="text-left "> {this.state.result.name}</h2>
                        </div>
                        ...
                        <div className="col-md-8 ">
                            <div className="row">
                                <div className="col-md-12 mt-2">
                                    <div className="description-col mt-lg-1 p-2 text-left">
                                        <h3>Description About Course</h3>
                                        <p>{this.state.result.description}</p>
                                        <h3>University/Institute</h3>
                    ...
                    <div className="row mt-3">
                        <div className="col-md-8 accordion-div">
                            <Paper elevation={3} >
                                <div className="">
                                    <Accordion>
