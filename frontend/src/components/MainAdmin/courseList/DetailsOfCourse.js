                ...
                <div className="col-md-12 mb-3">
                    ...
                    <div className="row row-1">
                        ...
                        <div className="col-md-8">
                            <Breadcrumbs aria-label="breadcrumb" className="ml-1 mt-2 text-white"><span><Link to="/ListOfCourses" style={{textDecoration:"none",color:"white"}}> Course List</Link> > {this.state.result.name}</span></Breadcrumbs>
