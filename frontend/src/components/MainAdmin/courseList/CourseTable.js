...
const CourseTable = (props)=> {
    ...
    useEffect(() => {
        const GetUsers = async () => {
            ...
            const result = await axios.get('http://localhost:5000/api/courses/details',{ headers: {"auth-token": token} });
            setUser(result.data);
            console.log(result);
        };
        GetUsers();
                                    ...
                                    <TableRow key={user._id}>
                                        ...
                                        <TableCell style={{ width: 200 }}  align="center">
                                            <ThemeProvider theme={customTheme}>
                                                ...
                                                <Button color="primary"><Link to={"/DetailsOfCourse/"+user._id}><TouchAppIcon/></Link></Button>&nbsp;
                                            </ThemeProvider>
                                        </TableCell>
                                    </TableRow>
                                ))}
